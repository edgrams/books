...
public class AvroGenericMaxTemperature extends Configured implements Tool {
    ...
    public static class MaxTemperatureMapper extends Mapper<LongWritable, Text, AvroKey<Integer>,
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setReducerClass(Chapter2.MaxTemperatureReducer.class);
